...
public class ParseModel extends XMLParser {
    boolean isEnvXML;
    int mNodeNum;
    ArrayList<MassDef> mMasses;
    ArrayList<FixedMassDef> mFixedMasses;
    ArrayList<SpringDef> mSprings;
    ArrayList<MuscleDef> mMuscles;

    public ParseModel () {
        isEnvXML = false;
        mMasses = new ArrayList<MassDef>();
        mFixedMasses = new ArrayList<FixedMassDef>();
        mSprings = new ArrayList<SpringDef>();
        mMuscles = new ArrayList<MuscleDef>();
    }
    ...
    private void parseMass (Attributes a) {
        checkIdXY(a);
        MassDef newMass = new MassDef(a.getValue("id"), a.getValue("x"), a.getValue("y"),
